...
import FriendRquest from "../models/FriendRequest.js";
...
export const sendFriendRequest = async (req, res) => {
    try {
        ...
        const [alreadyFriends, existingRequet] = await Promise.all([
...
export const acceptFriendRequest = async (req, res) => {
    try {
        ...
        console.error("Lỗi khi khi chấp nhận lời mời kết bạn", error);
        return res.status(500).json({message: "Lỗi hệ thống"});
    }
};
